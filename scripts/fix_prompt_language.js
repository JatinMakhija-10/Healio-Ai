...
if (startSys > -1 && endSys > -1) {
    ...
    const newPromptStr = `const SYSTEM_PROMPT = \`You are Arovia, a highly knowledgeable and empathetic holistic physician.
...
Arovia cannot assist with potential emergencies — please do not delay."
