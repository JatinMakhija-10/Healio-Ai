...
DROP VIEW IF EXISTS current_system_health CASCADE;
DROP VIEW IF EXISTS pending_doctors_count CASCADE;
DROP VIEW IF EXISTS flagged_sessions_count CASCADE;
DROP VIEW IF EXISTS ai_latency_stats CASCADE;
...
-- View: AI Latency Stats (Last 24 hours)
