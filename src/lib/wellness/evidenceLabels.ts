...
export const EVIDENCE_LABELS: Record<EvidenceLabelKey, EvidenceLabelConfig> = {
  clinically_established: {
    ...
    colorVar: 'var(--healio-evidence-established)',
    bgColorVar: 'var(--healio-evidence-established-bg)',
  },
  common_self_care: {
    ...
    colorVar: 'var(--healio-evidence-selfcare)',
    bgColorVar: 'var(--healio-evidence-selfcare-bg)',
  },
  traditional_practice: {
    ...
    colorVar: 'var(--healio-evidence-traditional)',
    bgColorVar: 'var(--healio-evidence-traditional-bg)',
  },
  emerging_limited: {
    ...
    colorVar: 'var(--healio-evidence-emerging)',
    bgColorVar: 'var(--healio-evidence-emerging-bg)',
  },
  avoid_or_consult: {
    ...
    colorVar: 'var(--healio-evidence-avoid)',
    bgColorVar: 'var(--healio-evidence-avoid-bg)',
  },
};
