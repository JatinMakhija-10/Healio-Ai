...
const STEP_META = [
    { icon: Smile, title: "Your Wellness Goal", desc: "What brings you to Arovia? This shapes everything we show you." },
...
export default function OnboardingWizard() {
    ...
    const handleComplete = async () => {
        ...
        const storageKey = user ? `arovia_pending_profile_${user.id}` : "arovia_pending_profile";
        ...
        try {
            ...
            localStorage.removeItem(`arovia_pending_profile_${user.id}`);
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <p className="text-xs text-slate-500 leading-relaxed">
                                                        ...
                                                        acknowledge that Arovia.AI is <strong>not a substitute for professional medical advice</strong>,
