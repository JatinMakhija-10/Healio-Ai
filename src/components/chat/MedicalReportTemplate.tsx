        ...
        >
                ...
                <div style={{
                    ...
                    <div style={{ flex: 1 }}>
                        ...
                        <p style={{
                            ...
                            This report is generated by an artificial intelligence system (Arovia.AI) and is intended for
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <p style={{ margin: 0 }}>© {currentDate.getFullYear()} Arovia.AI. All rights reserved.</p>
