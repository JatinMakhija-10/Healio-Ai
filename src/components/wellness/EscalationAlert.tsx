...
> = {
  L1: {
    ...
    colorVar: "var(--healio-escalation-l1)",
    bgColorVar: "var(--healio-wellness-primary-bg)",
  ...
  L2: {
    ...
    colorVar: "var(--healio-escalation-l2)",
    bgColorVar: "var(--healio-wellness-secondary-bg)",
  ...
  L3: {
    ...
    colorVar: "var(--healio-escalation-l3)",
    bgColorVar: "#FEF3C7",
  ...
  L4: {
    ...
    colorVar: "var(--healio-escalation-l4)",
    bgColorVar: "#FFF0EB",
  ...
  L5: {
    ...
    colorVar: "var(--healio-escalation-l5)",
    bgColorVar: "var(--healio-escalation-l5-bg)",
